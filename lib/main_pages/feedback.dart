...
import 'package:itouru/page_components/header.dart'; // Import the reusable header
import 'package:itouru/page_components/bottom_nav_bar.dart'; // Import the bottom nav bar
